            ...
            <div class="row">
              <div class="col-50">
                ...
                <div class="row">
                  ...
                  <div class="col-50">
                    <label for="gender">Account Type<span style="color: red;">*</span></label>
                ...
                <div class="row">
                  <div class="col-50">
                    <label for="adhar">Aadhaar No<span style="color: red;">*</span></label>
                    <input type="text" id="aadhar_no" name="aadhar_no" placeholder="Aadhaar No">
                  </div>
                  <div class="col-50">
                    <label for="mno">Mobile No<span style="color: red;">*</span></label>
                ...
                <div class="row">
                  ...
                  <div class="col-50">
                    <label for="panno">Pan Card No<span style="color: red;">*</span></label>
                ...
                <div class="row">
                  <div class="col-50">
                    <label for="gualification">Qualification<span style="color: red;">*</span></label>
